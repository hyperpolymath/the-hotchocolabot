...
:experimental:
:url-github: https://github.com/hyperpolymath/the-hotchocolabot
:url-gitlab: https://gitlab.com/hyperpolymath/the-hotchocolabot
:url-bitbucket: https://bitbucket.org/hyperpolymath/the-hotchocolabot
:url-codeberg: https://codeberg.org/hyperpolymath/the-hotchocolabot

Hot chocolate dispensing automation
...
the-hotchocolabot is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
